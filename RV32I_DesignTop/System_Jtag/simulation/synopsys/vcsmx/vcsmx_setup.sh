...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/System_Jtag_jtag_uart_0.v"          -work jtag_uart_0                             
  vlogan +v2k           "$QSYS_SIMDIR/submodules/ALU.v"                              -work RISCV_CORE_0                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/BRANCH_COMP.v"                      -work RISCV_CORE_0                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/CONTROL_UNIT.v"                     -work RISCV_CORE_0                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/DATA_MEM.v"                         -work RISCV_CORE_0                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Forwarding.v"                       -work RISCV_CORE_0                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/IMM_GEN.v"                          -work RISCV_CORE_0                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/INSTRUCTION_MEM.v"                  -work RISCV_CORE_0                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/MAC_UNIT.v"                         -work RISCV_CORE_0                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/MUX2X1.v"                           -work RISCV_CORE_0                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/PCSel_compute.v"                    -work RISCV_CORE_0                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/PIPES.v"                            -work RISCV_CORE_0                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/PROGRAM_COUNTER.v"                  -work RISCV_CORE_0                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/REG_FILE.v"                         -work RISCV_CORE_0                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/RISC_V.v"                           -work RISCV_CORE_0                            
  vlogan +v2k           "$QSYS_SIMDIR/System_Jtag.v"                                                                               
fi
